...
void main() {
  group('RefreshTokenInterceptor Tests', () {
    ...
    test('does not retry and propagates error if new token is null/empty', () async {
      dio.interceptors.add(
        RefreshTokenInterceptor(
          dio: dio,
          getRefreshToken: () async => 'valid_refresh_token',
    ...
    test('handles concurrent 401s by queueing waiters and calling refresh token only once', () async {

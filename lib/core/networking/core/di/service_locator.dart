...
import '../network/serializer/serializer_interface.dart';
...
Future<void> setupNetworking({
  ...
  // Serializer
  getIt.registerLazySingleton<Serializer>(() => const JsonSerializer());
...
Future<void> setupNetworkingWithApiConfig({
  ...
  // ApiConfig
  getIt.registerSingleton<ApiConfig>(config);
